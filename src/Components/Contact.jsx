...
export const Contact = () => {
  ...
  return (
    <div className="contactmain">
      <Header />
      <div
        className={`contact-main sm:pt-[2%] pt-[6%]`}
      >
        ...
        <div className="sm:w-[80%] w-[90%] p-[3px] sm:ml-[10%] ml-[5%] mr-[5%] sm:mr-[10%]">
          <form action="">
            <div className="flex sm:flex-row flex-col sm:gap-[4%] gap-[13%] h-[50px] sm:text-[20px] text-[15px] sm:mb-[2%] mb-[28%]">
            ...
            <div className="flex sm:flex-row flex-col sm:gap-[4%] gap-[13%] h-[50px] sm:text-[20px] text-[15px]] sm:mb-[2%] mb-[29%] ">
